        ...
        databaseReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                if (!snapshot.exists() || snapshot.getChildrenCount() == 0) {
                    Toast.makeText(VaccinesActivity.this, "No patient data found", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(VaccinesActivity.this, "Loaded " + patients.size() + " patients", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onCancelled(@NonNull DatabaseError error) {
                Toast.makeText(VaccinesActivity.this, "Error loading data: " + error.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
